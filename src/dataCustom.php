...
class datacustom
{
     ...
     * @param string $socket
     */
    public function __construct($host = DATA_LAYER_CONFIG["host"], $username = DATA_LAYER_CONFIG["username"], $password = DATA_LAYER_CONFIG["passwd"], $db =  DATA_LAYER_CONFIG["dbname"], $port = DATA_LAYER_CONFIG["port"], $charset = 'utf8', $socket = null)
    {
        $isSubQuery = false;
